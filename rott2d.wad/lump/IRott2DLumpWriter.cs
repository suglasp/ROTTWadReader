/*
 * ROTT2D
 * Unit: ROTT2D Lump Writer Interface
...
{
    /// <summary>
    /// Rott2D Lump writer interface
    /// </summary>
    public interface IRott2DLumpWriter : IRott2DLump
    {
        bool ExportLumpToFile(string filename, string ext);
    }
}
